...
import { Menu, X, FileText } from 'lucide-react'; // Replaced Download with FileText
...
export const Header: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <nav className="md:hidden bg-black p-4 shadow-md absolute top-full left-0  rounded-xl right-0">
