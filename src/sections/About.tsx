...
export const About: React.FC = () => {
  const skills = [
    { icon: <Code size={24} />, name: 'Languages', description: (<>Python <br/> C++ <br/> Java <br/>React</>) },
    { icon: <Code size={24} />, name: 'Tools/Platforms', description: 'Git & GitHub, Jupyter Notebook, EmailJS, Gemini API, MySQL Workbench' },
    { icon: <Target size={24} />, name: 'Soft Skills', description: 'Leadership & Team Coordination, Problem Solving & Analytical Thinking, Communication & Stakeholder Management' },
